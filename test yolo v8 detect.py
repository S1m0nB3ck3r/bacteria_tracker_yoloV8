...
if __name__ == "__main__":
    ...
    result_path = (
        "C:\\TRAVAIL\\developpement\\bacteria_tracker-main\\test yolo v8\\" + test_name
    )
    ...
    for path_image in detection_directories:
        ...
        path_orinal_images = (
            detection_directory + "\\" + path_image
        )  # chemin des images à detecter
        ...
        path_result_images_filtered = (
            result_path + "\\" + project_name + "\\images_filtered"
        )
        ...
        for i, result in enumerate(results):
            ...
            image_save_path = os.path.join(
                path_result_images, image_name_without_extension + "." + image_extension
            )
